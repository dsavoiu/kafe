...
class Fit_Test_numeric_tools_functionality(unittest.TestCase):
    ...
    def test_cor_to_cov(self):
        ...
        """
        assert np.allclose(self.REF_COV_MAT, numeric_tools.cor_to_cov(self.REF_COR_MAT, self.REF_ERR_LIST))

    def test_cov_to_cor(self):
        """
        Test of numeric_tools.cor_to_cov.
        """
        assert np.allclose(self.REF_COR_MAT, numeric_tools.cov_to_cor(self.REF_COV_MAT))

    def test_extract_statistical_errors(self):
        """
        Test of numeric_tools.cor_to_cov.
        """
        assert np.allclose(self.REF_ERR_LIST, numeric_tools.extract_statistical_errors(self.REF_COV_MAT))
